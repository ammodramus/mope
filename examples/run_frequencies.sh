...
# start with @@)
mope run data/data_example_frequencies.txt trees/mope_study_both.newick transitions/drift_transitions.h5 transitions/bottleneck_transitions.h5 data/data_example_frequencies_ages.txt 10000 --data-are-frequencies --debug --num-walkers 500
