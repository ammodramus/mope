...
def main():
    ...
    parser.add_argument('--num-families', type = positive_int, default = 30)
    ...
    parser.add_argument('--single-beta', action = 'store_true')
    parser.add_argument('--exact-ages', action = 'store_true')
    parser.add_argument('--heteroplasmic-only', action = 'store_true',
