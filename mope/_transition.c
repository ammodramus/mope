...
#define __PYX_HAVE__mope___transition
#define __PYX_HAVE_API__mope___transition
#include "string.h"
#include "stdio.h"
#include "stdlib.h"
...
/* Module declarations from 'mope._transition' */
...
static PyArrayObject *__pyx_f_4mope_11_transition_get_transition_matrix_var_N(int, int, int, double, int __pyx_skip_dispatch); /*proto*/
...
#define __Pyx_MODULE_NAME "mope._transition"
int __pyx_module_is_main_mope___transition = 0;

/* Implementation of 'mope._transition' */
...
static PyObject *__pyx_pf_4mope_11_transition_get_transition_matrix_var_N(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_N1, int __pyx_v_N2, int __pyx_v_N0, double __pyx_v_mu); /* proto */
...
static PyObject *__pyx_pw_4mope_11_transition_1get_transition_matrix_var_N(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyArrayObject *__pyx_f_4mope_11_transition_get_transition_matrix_var_N(int __pyx_v_N1, int __pyx_v_N2, int __pyx_v_N0, double __pyx_v_mu, CYTHON_UNUSED int __pyx_skip_dispatch) {
  PyArrayObject *__pyx_v_P_np = 0;
  __Pyx_memviewslice __pyx_v_P = { 0, 0, { 0 }, { 0 }, { 0 } };
  int __pyx_v_i;
  int __pyx_v_j;
  CYTHON_UNUSED long __pyx_v_domain_size;
  CYTHON_UNUSED PyObject *__pyx_v_x = NULL;
  double __pyx_v_f;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_P_np;
  __Pyx_Buffer __pyx_pybuffer_P_np;
  ...
  int __pyx_t_14;
  __Pyx_RefNannySetupContext("get_transition_matrix_var_N", 0);
  __pyx_pybuffer_P_np.pybuffer.buf = NULL;
  __pyx_pybuffer_P_np.refcount = 0;
  __pyx_pybuffernd_P_np.data = NULL;
  __pyx_pybuffernd_P_np.rcbuffer = &__pyx_pybuffer_P_np;

  /* "mope/_transition.pyx":22
 *     '''
 * 
 ...
 */
  ...
  __pyx_t_2 = __Pyx_PyInt_From_long((__pyx_v_N0 + 1)); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 22, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_4 = __Pyx_PyInt_From_long((__pyx_v_N0 + 1)); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 22, __pyx_L1_error)
  ...
  __pyx_t_6 = ((PyArrayObject *)__pyx_t_1);
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_P_np.rcbuffer->pybuffer, (PyObject*)__pyx_t_6, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float64_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) {
      __pyx_v_P_np = ((PyArrayObject *)Py_None); __Pyx_INCREF(Py_None); __pyx_pybuffernd_P_np.rcbuffer->pybuffer.buf = NULL;
      __PYX_ERR(0, 22, __pyx_L1_error)
    } else {__pyx_pybuffernd_P_np.diminfo[0].strides = __pyx_pybuffernd_P_np.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_P_np.diminfo[0].shape = __pyx_pybuffernd_P_np.rcbuffer->pybuffer.shape[0]; __pyx_pybuffernd_P_np.diminfo[1].strides = __pyx_pybuffernd_P_np.rcbuffer->pybuffer.strides[1]; __pyx_pybuffernd_P_np.diminfo[1].shape = __pyx_pybuffernd_P_np.rcbuffer->pybuffer.shape[1];
    }
  }
  __pyx_t_6 = 0;
  __pyx_v_P_np = ((PyArrayObject *)__pyx_t_1);
  __pyx_t_1 = 0;

  /* "mope/_transition.pyx":23
 * 
 *     cdef np.ndarray[np.float64_t,ndim=2] P_np = np.zeros((N0+1,N0+1))
 *     cdef double [:,:] P = P_np             # <<<<<<<<<<<<<<
 *     cdef int i, j
 * 
 */
  __pyx_t_7 = __Pyx_PyObject_to_MemoryviewSlice_dsds_double(((PyObject *)__pyx_v_P_np));
  if (unlikely(!__pyx_t_7.memview)) __PYX_ERR(0, 23, __pyx_L1_error)
  __pyx_v_P = __pyx_t_7;
  __pyx_t_7.memview = NULL;
  __pyx_t_7.data = NULL;

  /* "mope/_transition.pyx":26
 *     cdef int i, j
 * 
 *     domain_size = N2+1             # <<<<<<<<<<<<<<
 *     x = np.arange(N2+1)
 *     for i in range(N1+1):
 */
  __pyx_v_domain_size = (__pyx_v_N2 + 1);

  /* "mope/_transition.pyx":27
 * 
 *     domain_size = N2+1
 *     x = np.arange(N2+1)             # <<<<<<<<<<<<<<
 *     for i in range(N1+1):
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = __Pyx_PyInt_From_long((__pyx_v_N2 + 1)); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 27, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_5 = NULL;
 ...
 *         f = (1-mu)*f + (1-f)*mu
 */
  __pyx_t_8 = (__pyx_v_N1 + 1);
  for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_8; __pyx_t_9+=1) {
    __pyx_v_i = __pyx_t_9;

    /* "mope/_transition.pyx":29
 *     x = np.arange(N2+1)
 *     for i in range(N1+1):
 *         f = i/N1             # <<<<<<<<<<<<<<
 *         f = (1-mu)*f + (1-f)*mu
 ...
 */
    ...
    __pyx_v_f = (((double)__pyx_v_i) / ((double)__pyx_v_N1));

    /* "mope/_transition.pyx":30
 *     for i in range(N1+1):
 *         f = i/N1
 *         f = (1-mu)*f + (1-f)*mu             # <<<<<<<<<<<<<<
 *         for j in range(N2+1):
 ...
 */
    __pyx_v_f = (((1.0 - __pyx_v_mu) * __pyx_v_f) + ((1.0 - __pyx_v_f) * __pyx_v_mu));

    /* "mope/_transition.pyx":31
 *         f = i/N1
 *         f = (1-mu)*f + (1-f)*mu
 *         for j in range(N2+1):             # <<<<<<<<<<<<<<
 *             P[i,j] = binom_pmf(j,N2,f)
 *     return P_np
 */
    __pyx_t_10 = (__pyx_v_N2 + 1);
    for (__pyx_t_11 = 0; __pyx_t_11 < __pyx_t_10; __pyx_t_11+=1) {
      __pyx_v_j = __pyx_t_11;

      /* "mope/_transition.pyx":32
 *         f = (1-mu)*f + (1-f)*mu
 *         for j in range(N2+1):
 *             P[i,j] = binom_pmf(j,N2,f)             # <<<<<<<<<<<<<<
 *     return P_np
 */
      ...
      } else if (unlikely(__pyx_t_12 >= __pyx_v_P.shape[0])) __pyx_t_14 = 0;
      if (__pyx_t_13 < 0) {
        __pyx_t_13 += __pyx_v_P.shape[1];
        if (unlikely(__pyx_t_13 < 0)) __pyx_t_14 = 1;
      } else if (unlikely(__pyx_t_13 >= __pyx_v_P.shape[1])) __pyx_t_14 = 1;
      if (unlikely(__pyx_t_14 != -1)) {
        __Pyx_RaiseBufferIndexError(__pyx_t_14);
        __PYX_ERR(0, 32, __pyx_L1_error)
      }
      *((double *) ( /* dim=1 */ (( /* dim=0 */ (__pyx_v_P.data + __pyx_t_12 * __pyx_v_P.strides[0]) ) + __pyx_t_13 * __pyx_v_P.strides[1]) )) = __pyx_f_4mope_6_binom_binom_pmf(__pyx_v_j, __pyx_v_N2, __pyx_v_f, 0);
    }
  }

  /* "mope/_transition.pyx":33
 *         for j in range(N2+1):
 *             P[i,j] = binom_pmf(j,N2,f)
 *     return P_np             # <<<<<<<<<<<<<<
 */
  __Pyx_XDECREF(((PyObject *)__pyx_r));
  __Pyx_INCREF(((PyObject *)__pyx_v_P_np));
  __pyx_r = ((PyArrayObject *)__pyx_v_P_np);
  goto __pyx_L0;
 ...
 */
  ...
  { PyObject *__pyx_type, *__pyx_value, *__pyx_tb;
    ...
    __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_P_np.rcbuffer->pybuffer);
  __Pyx_ErrRestore(__pyx_type, __pyx_value, __pyx_tb);}
  __Pyx_AddTraceback("mope._transition.get_transition_matrix_var_N", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_P_np.rcbuffer->pybuffer);
  __pyx_L2:;
  __Pyx_XDECREF((PyObject *)__pyx_v_P_np);
...
static PyObject *__pyx_pw_4mope_11_transition_1get_transition_matrix_var_N(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("get_transition_matrix_var_N (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_N1,&__pyx_n_s_N2,&__pyx_n_s_N0,&__pyx_n_s_mu,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_N2)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("get_transition_matrix_var_N", 1, 4, 4, 1); __PYX_ERR(0, 6, __pyx_L3_error)
        }
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_N0)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("get_transition_matrix_var_N", 1, 4, 4, 2); __PYX_ERR(0, 6, __pyx_L3_error)
        }
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_mu)) != 0)) kw_args--;
        else {
          __Pyx_RaiseArgtupleInvalid("get_transition_matrix_var_N", 1, 4, 4, 3); __PYX_ERR(0, 6, __pyx_L3_error)
        }
      }
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "get_transition_matrix_var_N") < 0)) __PYX_ERR(0, 6, __pyx_L3_error)
      }
    ...
    __pyx_v_N1 = __Pyx_PyInt_As_int(values[0]); if (unlikely((__pyx_v_N1 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 7, __pyx_L3_error)
    __pyx_v_N2 = __Pyx_PyInt_As_int(values[1]); if (unlikely((__pyx_v_N2 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 8, __pyx_L3_error)
    __pyx_v_N0 = __Pyx_PyInt_As_int(values[2]); if (unlikely((__pyx_v_N0 == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 9, __pyx_L3_error)
    __pyx_v_mu = __pyx_PyFloat_AsDouble(values[3]); if (unlikely((__pyx_v_mu == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 10, __pyx_L3_error)
  }
  goto __pyx_L4_argument_unpacking_done;
  __pyx_L5_argtuple_error:;
  __Pyx_RaiseArgtupleInvalid("get_transition_matrix_var_N", 1, 4, 4, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 6, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("mope._transition.get_transition_matrix_var_N", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_4mope_11_transition_get_transition_matrix_var_N(__pyx_self, __pyx_v_N1, __pyx_v_N2, __pyx_v_N0, __pyx_v_mu);
...
static PyObject *__pyx_pf_4mope_11_transition_get_transition_matrix_var_N(CYTHON_UNUSED PyObject *__pyx_self, int __pyx_v_N1, int __pyx_v_N2, int __pyx_v_N0, double __pyx_v_mu) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannySetupContext("get_transition_matrix_var_N", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_1 = ((PyObject *)__pyx_f_4mope_11_transition_get_transition_matrix_var_N(__pyx_v_N1, __pyx_v_N2, __pyx_v_N0, __pyx_v_mu, 0)); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 6, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "mope._transition.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "mope._transition.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "mope._transition._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"get_transition_matrix_var_N", (PyCFunction)__pyx_pw_4mope_11_transition_1get_transition_matrix_var_N, METH_VARARGS|METH_KEYWORDS, __pyx_doc_4mope_11_transition_get_transition_matrix_var_N},
  {0, 0, 0, 0}
};
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC init_transition(void); /*proto*/
PyMODINIT_FUNC init_transition(void)
#else
PyMODINIT_FUNC PyInit__transition(void); /*proto*/
PyMODINIT_FUNC PyInit__transition(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  PyObject *__pyx_t_2 = NULL;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit__transition(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("_transition", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_mope___transition) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "mope._transition")) {
      if (unlikely(PyDict_SetItemString(modules, "mope._transition", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  __pyx_t_1 = __Pyx_ImportModule("mope._binom"); if (!__pyx_t_1) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ImportFunction(__pyx_t_1, "binom_pmf", (void (**)(void))&__pyx_f_4mope_6_binom_binom_pmf, "double (double, double, double, int __pyx_skip_dispatch)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init mope._transition", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init mope._transition");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
